...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Core services */}
      <section className="bg-teal-soft">
        <div className="mx-auto max-w-[1120px] px-4 py-14 md:px-6">
      ...
      {/* Trust + stats */}
      <section className="bg-teal-soft">
        <div className="mx-auto max-w-[1120px] px-4 py-14 text-center md:px-6 md:text-left">
          <SectionHeading title={content.trust.title} />
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              { value: "25 yrs", label: "Founder experience across FM sectors" },
          ...
          <p className="mx-auto mt-6 max-w-2xl text-sm leading-relaxed text-ink/80 md:mx-0">{content.trust.closing}</p>
      ...
      {/* CTA */}
      <section className="mx-auto max-w-[1120px] px-0 pb-0 md:px-6 md:pb-14">
        <div className="relative overflow-hidden bg-gradient-to-br from-navy to-forest px-6 py-12 text-center shadow-sm md:rounded-2xl md:px-12 md:py-14">
          <div
